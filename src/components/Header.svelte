  ...
  <div class="header__inner">
        ...
        <div class="header__page-info">
          ...
          <div class="header__breadcrumbs breadcrumbs">
            ...
            <span class="breadcrumbs__item breadcrumbs__item--current">
              <Link to={headerBreadcrumbs.current.href}
                >{headerBreadcrumbs.current.title}</Link
              >
            </span>
          </div>
        </div>
    ...
    <div class="header__actions">
      ...
      <div class="header__account account">
        ...
        <button
          type="button"
          on:click={unAuthHandler}
          class="account__link-leave account__link"
        >
