<script>
  ...
  auth.subscribe((data) => {
    if (data.filled) {
      ...
      buttonData = data.view.menu.button;
    }
  });
          ...
          <div class="draft">
            <div class="draft__statuses">
              <div class="draft__status-item status-item">
                <div
                  class="status-item__status-mark status-item__status-mark--new"
                ></div>
              ...
              <div class="draft__status-item status-item">
                <div
                  class="status-item__status-mark status-item__status-mark--pending"
                ></div>
                <div class="status-item__status-info-wrap">
              ...
              <div class="draft__status-item status-item">
                <div
                  class="status-item__status-mark status-item__status-mark--done"
                ></div>
                <div class="status-item__status-info-wrap">
            ...
            <ul class="bloggers__list">
              {#each widgetsData.author as item}
                <li class="bloggers__list-item">
                  <Blog
                    img={item.icon ? item.icon : "/michael.jpg"}
                    title={item.name}
                  />
                </li>
              {/each}
        ...
        <Widget title="Планировщик">
          <div class="article">
            ...
            <p class="article__text">
              В разделе «Заказы» появилась специальная кнопка для сканирования
              маркировки Честный знак при обработке заказов FBS
            </p>
          </div>
        </Widget>
      ...
      <div class="widgets__add">
        <ul class="widgets__variants-add">
          {#each buttonData as items}
            <li class="widgets__variant-add">{items.name}</li>
          {/each}
        </ul>
